...
\notebox{A última versão desse documento pode ser encontrada em \href{https://github.com/xexeo/Como-vamos-acabar-a-disserta-o-}{\url{https://github.com/xexeo/Como-vamos-acabar-a-disserta-o-}}}
...
\2 Aspas não são feitas com aspas (\verb!"!) mas sim com dois acentos graves (\`{}\`{}) no início e (\textquotesingle\textquotesingle), dois apóstrofes retos, no final.
\3 No teclado ABNT estão do lado esquerdo do 1 e do lado direito do P (com shift). 
